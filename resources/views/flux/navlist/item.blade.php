    ...
    ->add(match ($variant) {
        'outline' => match ($accent) {
            true => [
                ...
                'data-current:bg-zinc-200 dark:data-current:bg-zinc-200/[7%] data-current:border data-current:border-zinc-200 dark:data-current:border-transparent',
                'hover:text-zinc-800 dark:hover:text-white dark:hover:bg-zinc-200/[7%] hover:bg-zinc-200/5 ',
                'border border-transparent',
            ],
            false => [
                'data-current:text-zinc-800 dark:data-current:text-zinc-100 data-current:border-zinc-200',
                'data-current:bg-zinc-200 dark:data-current:bg-zinc-200/10 data-current:border data-current:border-zinc-200 dark:data-current:border-white/10 data-current:shadow-xs',
        ...
        default => match ($accent) {
            true => [
                'data-current:text-(--color-accent-content) hover:data-current:text-(--color-accent-content)',
                'data-current:bg-zinc-200/[4%] dark:data-current:bg-zinc-200/[7%]',
                'hover:text-zinc-800 dark:hover:text-white hover:bg-zinc-200/[4%] dark:hover:bg-zinc-200/[7%]',
            ],
            false => [
                'data-current:text-zinc-800 dark:data-current:text-zinc-100',
                'data-current:bg-zinc-200/[4%] dark:data-current:bg-zinc-200/10',
                'hover:text-zinc-800 dark:hover:text-white hover:bg-zinc-200/[4%] dark:hover:bg-zinc-200/10',
            ],
        },
    })
    ;
